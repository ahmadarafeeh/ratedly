...
class FirestoreBlockMethods {
  ...
  Future<void> blockUser({
    ...
    try {
      ...
      await batch.commit();
      print('Block operation completed successfully');
    } catch (e) {
  ...
  Future<bool> isUserBlocked({
    ...
    try {
      ...
      final data = targetUserDoc.data() as Map<String, dynamic>?;
